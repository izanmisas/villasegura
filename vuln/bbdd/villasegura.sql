...
-- Volcando datos para la tabla villasegura_db.tramites: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla villasegura_db.usuarios_admin: ~0 rows (aproximadamente)
INSERT INTO `usuarios_admin` (`id`, `usuario`, `password_hash`, `rol`, `ultimo_acceso`) VALUES
	(1, 'admin', '$2y$10$gmt6lY7uHEmrmnKp2Q4.2u/BeO5GPLUwElta9FBEYgMnXCqhBC7b2', 'administrador', '2026-04-27 18:06:07');
